...
public class TruthTableGUI {
    ...
    //To track the number of Trues (1's) in the output
    ...
    public void constructTable(){
        ...
        //Counts the 1's in the output by the static variable and tells result
        System.out.println("");
        if(trueCount>0){
    ...
    public void conditionalValues(int leftPos, int rightPos){
        if (((Integer) temp.get(leftPos) == 1 && ((Integer) temp.get(rightPos)) == 1) || ((Integer) temp.get(leftPos) == 0 && ((Integer) temp.get(rightPos)) == 1) || ((Integer) temp.get(leftPos) == 0 && ((Integer) temp.get(rightPos)) == 0 )){
            temp.set(rightPos, 1);
        }else{
            temp.set(rightPos, 0);
        }
    ...
    public void biconditionalValues(int leftPos, int rightPos){
        if (((Integer) temp.get(leftPos) == 1 && ((Integer) temp.get(rightPos)) == 1) || ((Integer) temp.get(leftPos) == 0 && ((Integer) temp.get(rightPos)) == 0 )){
            temp.set(rightPos, 1);
        }else{
            temp.set(rightPos, 0);
        }
    ...
    public void exorValues(int leftPos, int rightPos){
        if (((Integer) temp.get(leftPos) == 1 && ((Integer) temp.get(rightPos)) == 0) || ((Integer) temp.get(leftPos) == 0 && ((Integer) temp.get(rightPos)) == 1 )){
            temp.set(rightPos, 1);
        }else{
            temp.set(rightPos, 0);
        }
                ...
                if (temp.get(i).equals('~') && isInt(i+1)){
                    ...
                    if (isInt(i+1)){
                        if (temp.get(i).equals('|')){
                            ...
                            conditionalValues(i-1, i+1);
                        }else if (temp.get(i).equals('=')){
                            biconditionalValues(i-1, i+1);
                        }else if (temp.get(i).equals('#')){
                            exorValues(i-1, i+1);
                        }
                        ...
                        if (temp.get(i).equals('|')){
                            ...
                            conditionalValues(i-1, i+2);
                        }else if (temp.get(i).equals('=')){
                            biconditionalValues(i-1, i+2);
                        }else if (temp.get(i).equals('#')){
                            exorValues(i-1, i+2);
                        }
                        temp.set(i+1, "");
